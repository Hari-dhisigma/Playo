...
function V() {
  return (
    <div className="container1">
      ...
      <div class="heading">
      <div className="titlerow"><b >Bright Sports Center</b> </div>
        <div className="time">
        <i className="fa-solid fa-clock"></i>
      <span >5 AM - 12 PM</span></div> <br></br>
      <div className="locationrow">
        
        <i className="fa-solid fa-location-dot" />
      <span >
        Bright Sports Centre Vadacode P.O 
      </span>
      </div>
      <div className="locrow"><span >Kollamkudimugal, Kochi, Kerala</span></div>
 
   <div ><button type="button" className="buttonMap"><i className="fa-solid fa-location-dot" />Show in Map</button></div>
   </div>
      <hr></hr>
      <div className="rating">
      <div className="colr"><i class="fa-solid fa-star"></i><i class="fa-solid fa-star"></i><i class="fa-solid fa-star"></i><i class="fa-solid fa-star"></i><i class="fa-solid fa-star-half-stroke"></i>
     <b>4.53</b>(19 rating) </div> <div className="colr">|</div> <div className="colr"><b> 2.06k Total Activities</b></div> <br></br>
     </div>
     <div className="rowbtn">
     <div  className="colbtn"><button className="btnRating">Rate Venue</button></div>
     <div className="colbtn"><button className="btnRating">0 Upcoming</button></div>
     </div>
      <br></br>
      ...
      <div class="AvailableSp">
        ...
        <p>
          (Tap on the sport icon to see "Price Chart")
        </p>
 ...
 <Card >
  ...
  <Card >
      ...
      <div className="rowActivities">
        <b>Activities</b>
        <button className="btActivity"><b>+Create Activity</b></button>
      </div>
      <div class="about">
        <b>About Venue</b>
        <p>
          <div className="rowAbout">Only non-making shoes are allowed in the wooden court.</div>
          <div className="rowAbout">Badminton shoes and rackets are available for rent.</div>
          <div className="rowAbout">Badminton coaching Available</div>
        </p>
      </div>
      <div className="bookNow">
      <button class="btnBook">Book Now</button></div>
    </div>
  );
}
